...
<div class="page_wrap bg1 ">
    <div class="page">
        ...
        <style type="text/css">.column_left p,.column_left a,.column_left div,.leftmenu > li > a{font-size:13px !important;}</style>
    ...
    <li class="list-group-item text-center" style="padding-bottom:2%;"><input class="dropdown-item" name="tlnobandau" type="submit" value="Trả nợ với dư nợ giảm dần"/>
        ...
        <div class="column_middle">
                <h1>Tính lịch trả nợ với dư nợ giảm dần</h1>
                <div class="slideshow">
                </div>
<script type="text/javascript" src="https://quanlychitieu2030.herokuapp.com/MVC/view/pages/js/calendar.js">
...
<table bgcolor="#fafafa" border="0" bordercolor="#e2e2e2" cellpadding="0" cellspacing="0" class="tbl-loan-repayment">
	<tbody>
		...
		<tr>
			...
			<td align="left" width="80%"><input class="txt-loan-repayment" id="money" type="text" value="" tabindex="1"> VND</td>
		</tr>
		<tr>
			<td align="left" width="20%">
			<div class="text-loan-repayment">Thời gian vay</div>
			</td>
			<td align="left" width="80%"><input class="txt-loan-repayment" id="time" maxlength="3" type="text" value="" tabindex="2"> tháng</td>
		</tr>
		<tr>
			<td align="left" width="20%">
			<div class="text-loan-repayment">Lãi suất</div>
			</td>
			<td align="left" width="80%"><input class="txt-loan-repayment" id="percent" maxlength="4" type="text" value="" tabindex="3"> % năm</td>
		</tr>
		<tr>
			<td align="left" width="20%">
			<div class="text-loan-repayment">Ngày giải ngân</div>
			</td>
			<td align="left" width="80%"><input class="txt-date" id="date" readonly="readonly" type="text" value="" tabindex="4"> <img alt="Chọn ngày" id="btnDate" src="https://quanlychitieu2030.herokuapp.com/MVC/view/pages/img/khac/calendar-icon.gif"> <script type="text/javascript">//<![CDATA[
                        Calendar.setup({
                            inputField: "date",
                            trigger: "btnDate",
