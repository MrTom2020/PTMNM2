<form  action="../sogiaodich/ti" method="POST">
<div class="max-width text-center middle-things" style="margin-top:15vh;">
<div class="row">
...
<input type="submit" class="form-control"  name="st" id="useName" value="Một công cụ ghi chép tiền vào.">
</div>
</div>
<div class="col-md-4 col-lg-4 col-xs-6 animated fadeIn">
<div class="animated features-ml">
